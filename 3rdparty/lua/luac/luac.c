...
int save_string_to_file(const char* str, const char* filename) {
...
{
	save_string_to_file(message, "error_toluac.txt");
 //fprintf(stdout,"%s: %s\n",progname,message);
 exit(EXIT_FAILURE);
}
...
{
	save_string_to_file(what, "error_toluac.txt");
 //fprintf(stdout,"%s: cannot %s %s: %s\n",progname,what,output,strerror(errno));
 exit(EXIT_FAILURE);
}
